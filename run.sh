...
/home/anthony.li/.conda/envs/watermark/bin/parallel --no-tty --sshloginfile <(echo $expanded_nodes | sed 's/,$//') -j $SLURM_NTASKS_PER_NODE --progress bash ./detect.sh {1} {2} ::: gumbel ::: $(seq 1 10) < /dev/null
# /home/anthony.li/.conda/envs/watermark/bin/parallel --no-tty --slf $SLURM_JOB_NODELIST -j $SLURM_NTASKS_PER_NODE --progress bash ./detect.sh {1} {2} ::: gumbel ::: $(seq 1 500) < /dev/null
# /home/anthony.li/.conda/envs/watermark/bin/parallel --no-tty -j 500 --progress bash ./detect.sh {1} {2} ::: gumbel ::: $(seq 1 500) < /dev/null
